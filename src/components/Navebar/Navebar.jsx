...
function Navebar() {
    ...
    return (
        <nav className='px-2 lg-px-5 d-flex justify-content-end d-lg-block my-2'>
            <SignupModal setOpen={setOpen} open={open} setOpen2={setOpen2}/>
            <SignupModal2 open2={open2} setOpen2={setOpen2} setOpen={setOpen}/>
            <div className='d-none d-lg-flex justify-content-between align-items-center'>
                ...
                <label className='search d-flex align-items-center'>
                    <BsSearch />
                    <input type="text" placeholder='Search for your favourite groups' />
                </label>
